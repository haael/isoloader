...
HEADERS         = common.h config.h files.h match.h partition.h drivers.h bootiso.h
SRCS            = common.c config.c files.c match.c partition.c drivers.c bootiso.c main.c 
OBJS            = $(SRCS:.c=.o)
